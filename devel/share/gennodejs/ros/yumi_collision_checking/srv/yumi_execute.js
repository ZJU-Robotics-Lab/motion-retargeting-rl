...
// (in-package yumi_collision_checking.srv)
...
class yumi_executeResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _arraySerializer.float64(obj.xt, buffer, bufferOffset, null);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.xt = _arrayDeserializer.float64(buffer, bufferOffset, null)
