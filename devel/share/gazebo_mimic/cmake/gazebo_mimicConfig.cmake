...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_mimic_SOURCE_PREFIX /home/liweijie/projects/sl-rl-motion-retargeting-ws/src/yumi/gazebo_mimic)
  set(gazebo_mimic_DEVEL_PREFIX /home/liweijie/projects/sl-rl-motion-retargeting-ws/devel)
  ...
  set(gazebo_mimic_INSTALL_PREFIX /home/liweijie/projects/sl-rl-motion-retargeting-ws/install)
...
if(NOT "/home/liweijie/projects/sl-rl-motion-retargeting-ws/src/yumi/gazebo_mimic/include " STREQUAL " ")
  set(gazebo_mimic_INCLUDE_DIRS "")
  set(_include_dirs "/home/liweijie/projects/sl-rl-motion-retargeting-ws/src/yumi/gazebo_mimic/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_mimic' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/liweijie/projects/sl-rl-motion-retargeting-ws/src/yumi/gazebo_mimic/${idir}'.  ${_report}")
    endif()
