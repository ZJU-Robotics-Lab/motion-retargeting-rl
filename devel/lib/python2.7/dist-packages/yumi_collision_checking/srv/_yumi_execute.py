...
"""autogenerated by genpy from yumi_collision_checking/yumi_executeRequest.msg. Do not edit."""
import sys
...
def _get_struct_q():
    ...
    return _struct_q
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from yumi_collision_checking/yumi_executeResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class yumi_executeResponse(genpy.Message):
  _md5sum = "e081ccce00f48ee3a0e3b41932144db5"
  _type = "yumi_collision_checking/yumi_executeResponse"
  _has_header = False #flag to mark the presence of a Header object
...
float64 if_collide
"""
  __slots__ = ['xt_hat','Qt_hat','xt','Qt','x_next','Q_next','if_collide']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       xt_hat,Qt_hat,xt,Qt,x_next,Q_next,if_collide
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.xt))
      length = len(self.Qt)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.xt = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.xt = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
